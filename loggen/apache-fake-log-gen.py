...
parser.add_argument("--dir", "-d", dest='folder_dir', help="File directory into which the log is created", type=str)
...
for case in switch(output_type):
	if case('LOG'):
		f = open(folder_dir + outFileName,'w')
		break
	if case('GZ'):
		f = gzip.open(folder_dir + outFileName+'.gz','w')
		break
